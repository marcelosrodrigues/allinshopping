...
public class ClienteService
{
    ...
    public Cliente save(Cliente cliente)
        throws NoUniqueRegistryException
    {
        if (!CLIENTE_DAO.exists(cliente) && ( cliente.getId() == null || cliente.getId() == 0L))
        {
            ...
            throw new NoUniqueRegistryException("Não foi possível salvar o cliente. Já existe outro cadastrado com o mesmo CPF ou E-mail");
        }
    }
